...
public class ExposureNotificationSharedPreferences {
  ...
  private static final String PHONE_NUMBER_KEY = "ExposureNotificationSharedPreferences.PHONE_NUMBER_KEY";
  ...
  public void setPhoneNumber(String phone_number){
    sharedPreferences.edit().putString(PHONE_NUMBER_KEY, phone_number).apply();
  }
