...
import com.abishek.android.apps.exposurenotification.debug.proto.SignatureInfo;
import com.abishek.android.apps.exposurenotification.debug.proto.TEKSignature;
import com.abishek.android.apps.exposurenotification.debug.proto.TEKSignatureList;
import com.abishek.android.apps.exposurenotification.debug.proto.TemporaryExposureKeyExport;
...
public class KeyFileWriter {
  ...
  private static List<com.abishek.android.apps.exposurenotification.debug.proto.TemporaryExposureKey>
  toProto(List<TemporaryExposureKey> keys) {
    List<com.abishek.android.apps.exposurenotification.debug.proto.TemporaryExposureKey> protos =
        new ArrayList<>();
    for (TemporaryExposureKey k : keys) {
      protos.add(
          com.abishek.android.apps.exposurenotification.debug.proto.TemporaryExposureKey.newBuilder()
